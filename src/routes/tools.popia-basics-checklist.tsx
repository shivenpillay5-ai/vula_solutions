...
export const Route = createFileRoute("/tools/popia-basics-checklist")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A practical compliance checklist to help South African SMEs understand and meet their POPIA obligations — no legal jargon." },
...
function PopiaBasicsPage() {
  return (
    <ToolPage
      ...
      howTo={[
        "Work through each section in order — earlier sections inform later ones",
    ...
    >
      ...
      <ToolSection label="3. Have a lawful basis for every purpose">
        ...
        <Checklist items={[
          "Client contact details used to deliver a service → lawful basis: contract",
          "Employee payroll and HR records → lawful basis: legal obligation and contract",
          "Marketing emails and newsletters → lawful basis: consent (opt-in, not pre-ticked)",
          "Website analytics → lawful basis: legitimate interest (document why it outweighs privacy interests)",
          "Job applicant CVs → lawful basis: consent (and delete them within a reasonable period if unsuccessful)",
      ...
      <ToolSection label="6. Secure personal information">
        ...
        <Checklist items={[
          "Use strong, unique passwords for all systems containing personal data — use a password manager",
      ...
      <ToolSection label="7. Manage your operators (third-party processors)">
        <SectionIntro>
          An operator is any third party that processes personal information on your behalf — your email platform, payroll provider, cloud storage, CRM or accounting software. You remain responsible for how they handle your data.
        </SectionIntro>
        <Checklist items={[
      ...
      <ToolSection label="8. Know how to respond to a data breach">
        ...
        <Checklist items={[
          ...
          "Establish a simple breach response process: detect → contain → assess → notify",
